...
var PopupContainer = function (_React$Component) {
    ...
    _createClass(PopupContainer, [{
        ...
        value: function render() {
            return React.createElement("div", null, React.createElement("div", { style: { width: "578px", height: "348px", position: "relative", backgroundColor: "#fff", border: "solid 1px #ddd" } }, React.createElement("div", { style: { width: "578px", position: "absolute" } }, React.createElement("div", { style: { float: "left", width: "259px", margin: "20px 20px 20px 20px" } }, React.createElement(Calendar, { defaultValue: this.state.from, onChange: this.fromChange })), React.createElement("div", { style: { float: "left", width: "259px", margin: "20px 20px 20px 0" } }, React.createElement(Calendar, { defaultValue: this.state.to, onChange: this.toChange })))));
        }
    }]);
