    ...
    _createClass(PopupDateRangeInner, [{
        ...
        value: function render() {
            ...
            if (this.state.opened) {
                userInfoPopup = React.createElement(_PopupContainer2.default, { value: this.state.selectedValue, onChange: this.onChange });
            }
            return React.createElement("div", { className: "dropdown-container" + (this.state.opened ? " show" : ""), style: this.props.style }, React.createElement("div", { className: "form-group form-date" }, React.createElement("input", { type: "text", className: "form-input", ref: "container", value: this.state.selectedValue, onChange: this.inputOnChange }), React.createElement("button", { onClick: this.show, className: "form-date-picker btn-clear b-icon icon-date-pick" })), React.createElement("div", { className: "dropdown-list", ref: "dropdown-list" }, React.createElement("div", null, userInfoPopup)));
        }
    }]);
