...
var PopupDateRangeInner = function (_React$Component) {
    ...
    _createClass(PopupDateRangeInner, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", __assign({ className: "dropdown-container" + (this.state.opened ? " show" : "") }, this.props), React.createElement("div", { className: "form-group form-date" }, React.createElement("input", { type: "text", className: "form-input", ref: "container", value: this.state.selectedValue, onChange: this.inputOnChange }), React.createElement("button", { onClick: this.show, className: "form-date-picker btn-clear b-icon icon-date-pick" })), React.createElement("div", { className: "dropdown-list", ref: "dropdown-list" }, React.createElement("div", null, userInfoPopup)));
        }
    }]);
